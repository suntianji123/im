...
func (*UserInfo) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case userinfo.FieldID, userinfo.FieldStatus:
			values[i] = new(sql.NullInt64)
		case userinfo.FieldUsername, userinfo.FieldPassword, userinfo.FieldNickname, userinfo.FieldAvatar, userinfo.FieldExt:
