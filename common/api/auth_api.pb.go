...
func (x *AuthReq) GetDeviceType() int32 {
	if x != nil {
		return x.DeviceType
	}
	return 0
...
func (x *AuthCheckReq) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *AuthCheckReq) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *AuthCheckReq) GetDeviceType() int32 {
	if x != nil {
		return x.DeviceType
	}
	return 0
...
var file_auth_api_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x51, 0x0a, 0x07, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71, 0x12, 0x10,
	...
	0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x20, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65,
	0x73, 0x70, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x6c, 0x0a, 0x0c, 0x41, 0x75, 0x74, 0x68,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x70,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x65, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x25, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x0c, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71, 0x1a, 0x0b, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x28, 0x01, 0x12, 0x2f, 0x0a, 0x09,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x12, 0x11, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x41, 0x75, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x1a, 0x0b, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x28, 0x01, 0x42, 0x08, 0x5a,
...
var file_auth_api_proto_goTypes = []interface{}{
	(*AuthReq)(nil),      // 0: api.AuthReq
	(*AuthResp)(nil),     // 1: api.AuthResp
	(*AuthCheckReq)(nil), // 2: api.AuthCheckReq
	(*Result)(nil),       // 3: api.Result
}
var file_auth_api_proto_depIdxs = []int32{
	0, // 0: api.AuthService.Auth:input_type -> api.AuthReq
	2, // 1: api.AuthService.CheckAuth:input_type -> api.AuthCheckReq
	3, // 2: api.AuthService.Auth:output_type -> api.Result
	3, // 3: api.AuthService.CheckAuth:output_type -> api.Result
