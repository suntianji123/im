...
func (fq *FriendQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (fq *FriendQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(friend.Table, friend.Columns, sqlgraph.NewFieldSpec(friend.FieldID, field.TypeInt64))
	_spec.From = fq.sql
